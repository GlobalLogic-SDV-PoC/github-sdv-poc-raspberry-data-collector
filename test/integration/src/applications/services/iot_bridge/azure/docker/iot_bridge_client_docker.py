...
from src.applications.services.iot_bridge.azure.docker.config_provider.config_iot_bridge_service_provider  import \
...
class IotBridgeClientDocker(BaseDockerClient):
    container_name = "raspberry-azure-iot-bridge"
